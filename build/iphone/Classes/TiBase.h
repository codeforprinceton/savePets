...
// in simulator we redefine to format for SAVE Developer console
...
{\
	NSString * exceptionName = [@"org.save." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.save";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISAVENativeItemNone = -1, 
	UISAVENativeItemSpinner = -2,
	UISAVENativeItemProgressBar = -3,
	
	UISAVENativeItemSlider = -4,
	UISAVENativeItemSwitch = -5,
	UISAVENativeItemMultiButton = -6,
	UISAVENativeItemSegmented = -7,
	
	UISAVENativeItemTextView = -8,
	UISAVENativeItemTextField = -9,
	UISAVENativeItemSearchBar = -10,
	
	UISAVENativeItemPicker = -11,
	UISAVENativeItemDatePicker = -12,
	
	UISAVENativeItemInfoLight = -13,
	UISAVENativeItemInfoDark = -14,
	
	UISAVENativeItemDisclosure = -15,
	
	UISAVENativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SAVE instances of
